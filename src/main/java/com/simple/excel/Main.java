...
public class Main {
    ...
    public static String TABLE_DATA1 = "3\t3\n"
                                        +"=A2+B2+2*3*A2\t'2\t3\n"
                                        +"5\t6\t\n"
                                        +"=2*A1-3";
    ...
    public static String TABLE_DATA3 = "3\t5\n"
                                        ...
                                        +"6\t=A3\t=A1\t=C3\t-9";
    public static String TABLE_DATA4 = "3\t5\n"
                                        +"=B2\t1\t2\t=B1\t4\n"
                                        +"5\t=C2+D2+E2\t=A3\t=A3+B3\t=B3\n"
                                        +"=A1\t=A3\t7\t=8\t9";

    public static String TABLE_DATA5 = "3\t3\n"
            +"=A2\t4\t3\n"
            +"5\t6\t7\t\n"
            +"=2*A1-3\t7\t6\n";

    public static String TABLE_DATA6 = "1\t2\n"
            +"-11\t4\n";

    public static String TABLE_DATA7 = "3\t4\n"
            +"12\t=C2\t3\t'Sample\n"
            +"=A1+B1*C1/5\t=A2*B1\t=B3-C3\t'Spread\n"
            +"'Test\t=4-3\t5\t'Sheet\n";

    public static void main(String[] args) {
        String tableString = TABLE_DATA4;
        ...
        table.getMatrix().printStringValueTable();
