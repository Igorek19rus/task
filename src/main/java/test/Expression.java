...
import static test.Operation.opPrior;
import static test.Operation.parseOperation;
...
public class Expression {
     ...
     */
    private static List<DataWrapper> getRPN(final List<DataWrapper> rightSideInSplit)
    {
     ...
     */
    public void calculate(final Map<Cell, String> data)
    {
    ...
    public Set<Cell> parseDependencies(Cell[][] tableCells)
    {
        Set<Cell> directDependencies = new HashSet<Cell>();
        ...
        for(DataWrapper term : terms)
        {
            ...
            {
                String cellId = term.getStringValue();
                int[] cellPositions = Cell.getPositions(cellId);
                directDependencies.add(tableCells[cellPositions[0]][cellPositions[1]]);
            }
        }
        return directDependencies;
    }
