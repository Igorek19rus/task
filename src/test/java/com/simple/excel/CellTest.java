...
public class CellTest
{
    ...
    final String CHILDREN_DEPENDENCIES_EXPRESSION = "=A1+B11-C1+5-D2";
    ...
    public void initTypeTest() {
        ...
        assertEquals(childrenCellDependancies, cell.getChildrenCellDependancies());
        ...
        cell.initType();
        cell.initChildrenCellDependancies();
        cell.getExpression().setCalculated(FormulaImpl2.calculate(data, SIMPLE_EXPRESSION).getStringValue());
        cell.calculateValue();
        ...
        cell.initType();
        cell.initChildrenCellDependancies();
        cell.getExpression().setCalculated(FormulaImpl2.calculate(data, REFERENCE_NEGATIVE_EXPRESSION).getStringValue());
        cell.calculateValue();
        assertEquals(CellType.EXPRESSION, cell.getType());
        assertEquals(ErrorMessage.NO_ERROR, cell.getError());
        assertNotNull(cell.getExpression());
        ...
        cell.initType();
        cell.initChildrenCellDependancies();
        cell.getExpression().setCalculated(FormulaImpl2.calculate(data, REFERENCE_EXPRESSION).getStringValue());
        cell.calculateValue();
        assertEquals(CellType.EXPRESSION, cell.getType());
        assertEquals(ErrorMessage.NO_ERROR, cell.getError());
        assertNotNull(cell.getExpression());
        ...
        childrenCellDependancies.add(new CellId("C1"));
